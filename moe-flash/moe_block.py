...
from xkv_cache import XKVConfig
    ...
    def __init__(
        ...
        if use_mla:
            self.attention = MultiHeadLatentAttentionGQA(
                ...
                layer_idx=layer_idx, xkv_cfg=xkv_cfg,
            )
        else:
        ...
        if use_moe:
            self.ffn = MoELayer(
                ...
                expert_dim=expert_dim or inter_dim,
    ...
    def __init__(self, num_layers, d_model, num_heads, num_kv_groups=0,
        ...
        for i in range(num_layers):
            ...
            layers.append(LayerWithMoE(
                ...
                n_experts=n_experts_list[i], top_k=top_k,
