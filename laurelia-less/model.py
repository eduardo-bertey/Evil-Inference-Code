"""TransformerLM — Dense GQA keyless, basado en LLM_350M_DENSE.

Atención sin K (Q' = X·WQ·WR, scores contra V, cache solo-V),
proyecciones V y O densas, FFN intacto.
...
class LLM(nn.Module):
    ...
    def aux_total(self):
        """Sin MoE: siempre 0.0 (compat con train.py)."""
