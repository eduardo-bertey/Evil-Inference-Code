"""Cortexia Train: Sandwich MLA + BMA + Gated, Dense, FP16.

Arquitectura: MLA + BMA (pre-aggregation) + Gated (post-aggregation)
en TODAS las capas. Sin MoE. 20 capas, 32k BPE, contexto 1024.
"""
...
def main():
    ...
    print(f"MLA+Gated({gated_type})+BMA: d_c={d_c_real} d_c1={d_c1_real} d_rot={d_rot_real} | cache: {gqa_cpt}→{cpt}B/tok ({pct:.0f}%)")
